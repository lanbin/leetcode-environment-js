 ...
 * @Last Modified time: 2018-12-19 12:09:32
 */
import {
    expect
} from 'chai'
import removeElement from '../src/removeElement27.js'
...
describe('removeElement', _ => {
    ...
    it('[3,2,2,3]', done => {
        ...
        expect(array.slice(0, remainNum))
            .to.be.deep.equal([2, 2])
        done()
    })
